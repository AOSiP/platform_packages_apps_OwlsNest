...
package com.illusion.box.fragments.personal;
...
public class PersonalSettings extends SettingsPreferenceFragment {

    private static final String TAG = "personal_title";
    ...
    class StatusBarAdapter extends FragmentPagerAdapter {
        ...
        public StatusBarAdapter(FragmentManager fm) {
            super(fm);
            frags[0] = new DisplayAnimationsSettings();
