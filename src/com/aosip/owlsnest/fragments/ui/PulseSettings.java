...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerPref.setDefaultValue(AOSiPUtils.getThemeAccentColor(getContext()));
        ...
        if (colorMode == COLOR_TYPE_ACCENT) {
            mColorPickerPref.setNewPreviewColor(AOSiPUtils.getThemeAccentColor(getContext()));
        }
