...
public class NavigationHolder extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_HARDWARE_KEYS_DISABLE = "hardware_keys_enable";
    ...
    private Preference mHwKeyDisable;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHwKeyDisable = (Preference) findPreference(KEY_HARDWARE_KEYS_DISABLE);
        ...
        if (deviceKeys == 0) {
            ...
            prefSet.removePreference(mHwKeyDisable);
    ...
    private boolean isNavbarVisible() {
        boolean defaultToNavigationBar = aosipUtils.deviceSupportNavigationBar(getActivity());
    ...
    private void navbarCheck() {
        ...
        if (aosipUtils.isThemeEnabled("com.android.internal.systemui.navbar.threebutton")) {
            ...
            rightVerticalSwipeCategory.setVisible(false);
            mGestureBarSize.setVisible(false);
        } else if (aosipUtils.isGestureNavbar()) {
            ...
            public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean enabled) {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (deviceKeys == 0) {
                        ...
                        keys.add(KEY_HARDWARE_KEYS_DISABLE);
                    }
                    if (!hasMenu) {
