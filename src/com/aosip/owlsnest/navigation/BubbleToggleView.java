...
import com.aosip.owlsnest.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_aosip_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_aosip_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_aosip_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_aosip_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_aosip_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_aosip_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_aosip_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_aosip_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_aosip_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_aosip_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_aosip_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_aosip_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_aosip_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_aosip_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_aosip_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
